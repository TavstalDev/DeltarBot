...
public class PlayerStatsCommand : SimpleCommand
{
    public PlayerStatsCommand(DiscordSocketClient client, WynnHttpClient wynnClient, GuildService guildService) : base(
        "pstats",
        "TODO",
